  ...
  $(function () {
    Manager = new AjaxSolr.Manager({
      //solrUrl: 'http://reuters-demo.tree.ewdev.ca:9090/reuters/'
	   //solrUrl: 'http://localhost:8983/solr/#/master_uk-consultingOnline_Product/'
		  
	   solrUrl:'http://localhost:8983/solr/master_uk-consultingOnline_Product/select?q=*%3A*&wt=json&indent=true'	
		   
	   //solrUrl:'http://localhost:8983/solr/master_uk-consultingOnline_Product/select?q=*%3A*&wt=json&indent=true&facet=true&facet.query=workingYears'
