...
public class ConsultantCommerceCartMergingStrategy extends AbstractCommerceCartStrategy implements CommerceCartMergingStrategy
{

	private UserService userService;
	private CommerceCartService commerceCartService;
	private BaseSiteService baseSiteService;
	private ConsultantCommerceMergeAddCartStrategy commerceAddToCartStrategy;

	@Override
	/**
	 * Modify the OOTB merging cart Strategy since the OOTB model 
	 * could not adapt the StockLevel with 1 ConsultantModel validation strategy for the consultant session cart
	 * Assume the Consultant StockLevel with specific guy is 1
	 * @param ctx
	 * @param CartModel fromCart
	 * @param CartModel toCart          
	 * @param List<CommerceCartModification> modifications
	 */
	...
	/**
	 * mergeModificationToList merge the session cart into on modifcation list
	...
	/**
	 * mergeStatusCodes set the CommerceCartModificationStatus
	 * @param statusCode
	 * @param statusCode1
	 * 
	 */
	...
	public ConsultantCommerceMergeAddCartStrategy getCommerceAddToCartStrategy()
	{
		return commerceAddToCartStrategy;
	}

	@Required
	public void setCommerceAddToCartStrategy(final ConsultantCommerceMergeAddCartStrategy commerceAddToCartStrategy)
	{
