...

{
	...
	/**
	 * Modify the updateQuantityForCartEntry strategy for validation the consultant 
	 * model with StockLevel is 1,the OOTB need verify the quality match the StockLevel
			...
			final long actualAllowedQuantityChange, final long newQuantity, final Integer maxOrderQuantity)
	{
		...
		else
		{
			...
			//Return the session cart data meanwhile put the new quantity
