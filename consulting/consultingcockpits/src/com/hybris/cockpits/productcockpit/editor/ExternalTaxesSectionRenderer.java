 ...
 *
 */
package com.hybris.cockpits.productcockpit.editor;
			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("consultingcockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("consultingcockpits.product.externalTaxes"));
