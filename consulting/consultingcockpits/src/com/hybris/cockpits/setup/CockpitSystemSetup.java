 ...
 *
 */
package com.hybris.cockpits.setup;
...
import com.hybris.cockpits.constants.ConsultingCockpitsConstants;
 ...
 */
@SystemSetup(extension = ConsultingCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(ConsultingCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(ConsultingCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						ConsultingCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/consultingcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
