...
public class SearchPageController extends AbstractSearchPageController
{
	...
	CountrySelectedCookieGenerator countrySelectedCookieGenerator;
			...
			final HttpServletRequest request, final Model model) throws CMSItemNotFoundException
	{
		...
		//final String countrySelected = getConsultantFacade().getCountrySelectedForSession(false);
		// Store newly selected country in cookie
		//countrySelectedCookieGenerator.addCookie(response, countrySelected);
		...
		if (StringUtils.isNotBlank(searchText))
		{
			...
			// Could just add on country here !!
