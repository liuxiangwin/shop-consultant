...
<div id="header" class="clearfix">
	...
	<cms:pageSlot position="CountryLink" var="component" limit="1" class="header_countryLink">
		<cms:component component="${component}" class="countryLink"  element="div"/>
	</cms:pageSlot>
	
	<br />
	
	<%-- <div class="header_countryLink_Label">
		<c:out value="The current selected country is ${selectedCountry}"></c:out>   
	</div> --%>
