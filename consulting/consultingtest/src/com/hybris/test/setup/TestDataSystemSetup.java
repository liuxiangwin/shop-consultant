...
import com.hybris.test.constants.ConsultingTestConstants;
 ...
 */
@SystemSetup(extension = ConsultingTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/consultingtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/consultingtest/import/reviews.impex");
			...
			importImpexFile(context, "/consultingtest/import/cstickets.impex");
		}
	}
}
