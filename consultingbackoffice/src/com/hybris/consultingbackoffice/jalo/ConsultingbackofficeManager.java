 ...
 */
package com.hybris.consultingbackoffice.jalo;
...
import com.hybris.consultingbackoffice.constants.ConsultingbackofficeConstants;
 ...
 */
public class ConsultingbackofficeManager extends GeneratedConsultingbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(ConsultingbackofficeManager.class.getName());
	 ...
	 */
	public static ConsultingbackofficeManager getInstance()
	{
		return (ConsultingbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(ConsultingbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ConsultingbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ConsultingbackofficeManager called.");
		}
	}
