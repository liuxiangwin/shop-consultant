...
public class FranchisingCommerceAddToCartStrategy extends AbstractCommerceAddToCartStrategy
{
	/**
	...
	public CommerceCartModification addToCart(final CommerceCartParameter parameter) throws CommerceCartModificationException
	{
		...
		try
		{
			...
			final String fromFranchising = parameter.getFromFranchising();
			...
			catch (final UnknownIdentifierException e)
			{
				...
				modification.setFromFranchising("false");
				return modification;
			}
			...
			if (actualAllowedQuantityChange > 0)
			{
				...
				if (cartEntryModel != null)
				{
					cartEntryModel.setFromFranchising(fromFranchising);
				}
				...
				modification.setQuantity(quantityToAdd);
				modification.setFromFranchising(fromFranchising);
