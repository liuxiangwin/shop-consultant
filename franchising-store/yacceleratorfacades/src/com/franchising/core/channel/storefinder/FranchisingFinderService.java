 ...
 */
public class FranchisingFinderService<ITEM extends PointOfServiceDistanceData> implements
		StoreFinderService<ITEM, StoreFinderSearchPageData<ITEM>>
{
	private static final Logger LOG = Logger.getLogger(FranchisingFinderService.class);
