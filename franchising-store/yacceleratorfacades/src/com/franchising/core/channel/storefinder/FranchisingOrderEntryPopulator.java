 ...
 */
public class FranchisingOrderEntryPopulator implements Populator<AbstractOrderEntryModel, OrderEntryData>
{
	...
	{
		entry.setFromFranchising(orderEntry.getFromFranchising());
